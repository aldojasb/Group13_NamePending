...
We trained several machine learning models and found that a KNN model with hyperparameters [TODO: __] performed best during cross validation. This model achieved a score of [TODO: __] on the test set.
...
We are used the following packages for our analysis sklearn [@scikit-learn], python [@Python], pandas [@reback2020pandas], knitr [@knitr], numpy [@2020NumPy-Array], scipy [@2020SciPy-NMeth], [@romer2007homogeneous], altair [@2018-altair], and joblib [@Joblib]
