...
After running the models, we used the test-score metrics to evaluate our model prediction performance. As we can assess into the table below, Model KNN is the best in terms of test-score metrics, with XXX in comparison with other models (XXXXX)

```{r}
knitr::include_graphics("../results/dummy_table.PNG")
